...
### Initial Setup
Using the configuration file is done throught the `Config<T>` class. You can create an instance of this class by providing the plugin instance, the codec of your configuration class, and the file name for the configuration file.

In your project's `JavaPlugin` class, you should load the configuartion file in the constructor of the plugin, if it is loaded after the setup is done it will throw and error.
